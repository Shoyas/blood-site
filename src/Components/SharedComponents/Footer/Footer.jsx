            ...
            <div className="container container-fluid">
                <div className="row">
                    ...
                    <div className="col-md-4">
                        ...
                        <Link className="nav-link menu-item"><ul>
                        ...
                        <Link className="nav-link menu-item"><ul>
                            <li><strong className="menu-tag">Contacts</strong></li>
                        </ul></Link>
                    </div>
                    <div className="col-md-4">
                        <div className="tag-heading">
                        ...
                        <div className="tag-heading mt-5">
                            ...
                            <div className="social-media d-flex">
                                <Link className="nav-link media-item"><FaFacebookF/></Link>
                                <Link className="nav-link media-item"><AiOutlineTwitter /></Link>
                                <Link className="nav-link media-item"><FaGooglePlusG /></Link>
                                <Link className="nav-link media-item"><FaLinkedinIn /></Link>
                                <Link className="nav-link media-item"><AiOutlineInstagram /></Link>
                            </div>
